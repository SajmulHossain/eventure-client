...
export const EventCard = ({
  ...
  const canJoin = role === "USER" && event.status === EventStatus.OPEN;
  const canManage = (role === "HOST" || role === "ADMIN") && (onEdit || onDelete);
    ...
    >
      ...
      <div className="relative aspect-4/3 w-full overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="h-9 w-9 rounded-full bg-white/10 text-white backdrop-blur-md hover:bg-white/20 hover:text-red-400 transition-colors"
                  >
          ...
          {/* Edit/Delete Menu (for hosts and admins) */}
          {canManage && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  size="icon"
                  variant="ghost"
                  className="h-9 w-9 rounded-full bg-white/10 text-white backdrop-blur-md hover:bg-white/20 transition-colors"
                >
